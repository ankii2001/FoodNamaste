...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51OSk3BSGoWfNsqzxBCwgTwsd1c1CApkEVoVZ0l4oFzz1LwAKoifluKOQTuCgCEES14VJ3ew9D2NdlaEwxFOtaMNI00BbylxidK");
        ...
        const response = await fetch("https://food-namaste-server.vercel.app/api/create-checkout-session",{
            method:"POST",
            headers:headers,
